...
m.plot()
# %% [markdown]
# Change the size to get higher resolution. The default is 10 inches. The text size is
# adjusted accordingly when the size is set, but the points will be smaller. This can
# be solved with by buffering.
# %%
m = sg.ThematicMap(sg.buff(points, 100), column="mean_dist_99_neighbors", size=50)
