...
```
    ...
    Network(3851 km, directed=False)
...
```
    ...
    Network(3832 km, directed=False)
...
```
    ...
    DirectedNetwork(3407 km, directed=True)
...
```
    ...
    DirectedNetwork(6364 km, directed=True)
...
![png](network_analysis_demo_template_files/network_analysis_demo_template_30_1.png)
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>312</td>
      <td>9.932573</td>
      <td>MULTILINESTRING Z ((269879.102 6650558.199 189...</td>
    </tr>
    <tr>
      <th>1</th>
      <td>1</td>
    ...
    <tr>
      ...
      <td>411</td>
      <td>7.950584</td>
      <td>MULTILINESTRING Z ((265534.796 6653316.404 229...</td>
    </tr>
    <tr>
      <th>...</th>
      <td>...</td>
    ...
    <tr>
      ...
      <td>910</td>
      <td>5.325032</td>
      <td>MULTILINESTRING Z ((264495.200 6650512.560 85....</td>
    </tr>
    <tr>
      <th>96</th>
      <td>1</td>
    ...
    <tr>
      ...
      <td>616</td>
      <td>12.541341</td>
      <td>MULTILINESTRING Z ((256550.647 6653755.577 144...</td>
    </tr>
    <tr>
      <th>98</th>
      <td>1</td>
...
![png](network_analysis_demo_template_files/network_analysis_demo_template_33_1.png)
...
![png](network_analysis_demo_template_files/network_analysis_demo_template_35_0.png)
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>5</td>
      <td>75</td>
      <td>MULTILINESTRING Z ((267304.400 6643500.840 133...</td>
    </tr>
    <tr>
      <th>10</th>
      <td>10</td>
    ...
    <tr>
      ...
      <td>15</td>
      <td>75</td>
      <td>MULTILINESTRING Z ((266351.263 6639416.154 169...</td>
    </tr>
    <tr>
      <th>12</th>
      <td>5</td>
...
```
    ...
    c:\Users\ort\AppData\Local\Programs\Python\Python311\Lib\site-packages\mapclassify\classifiers.py:255: UserWarning: Not enough unique values in array to form 10 classes. Setting k to 7.
      warnings.warn(

![png](network_analysis_demo_template_files/network_analysis_demo_template_40_1.png)
...
![png](network_analysis_demo_template_files/network_analysis_demo_template_48_0.png)
...
```
    ...
    Network(3408 km, directed=False)
...
```
    ...
    c:\Users\ort\git\ssb-gis-utils\src\gis_utils\directednetwork.py:201: UserWarning: Your network is likely not directed. Only 0.0 percent of the lines go both ways. Try setting direction_col='oneway' in the 'make_directed_network' method
      warnings.warn(mess)
...
```
    ...
    c:\Users\ort\git\ssb-gis-utils\src\gis_utils\directednetwork.py:87: UserWarning: Minute column will not be calculated when both 'minute_cols', 'speed_col' and 'flat_speed' is None
      warnings.warn(
